...
> = {
  ...
  amount0In: AddLiquidityInstructionDataArgs["amount0In"];
  amount1In: AddLiquidityInstructionDataArgs["amount1In"];
  minLiquidityOut: AddLiquidityInstructionDataArgs["minLiquidityOut"];
};
