...
import { fetchPoolPerformance, type PoolPerformanceStats } from '@/integrations/indexer/analytics'
import { formatCompact, formatPercent, formatTokenAmount } from '@/shared/utils/format'
