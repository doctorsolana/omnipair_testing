...
import PoolPerformanceDashboard from '@/features/poolDetail/ui/PoolPerformanceDashboard'
import BorrowRiskPanel from '@/features/poolDetail/ui/BorrowRiskPanel'
import SwapTape from '@/features/poolDetail/ui/SwapTape'
...
function PoolDetailPage() {
  ...
  const isWalletConnected = Boolean(isConnected && account)
                  ...
                  {liquidityMode === 'deposit' && (
                    <>
                      ...
                      <button
                        ...
                        disabled={
                          depositSubmitting ||
                          (isWalletConnected && (!depositAmount0 || !depositAmount1))
                        }
                      >
                        {depositSubmitting
                          ? 'Depositing…'
                  ...
                  {liquidityMode === 'withdraw' && (
                    <>
                      ...
                      <button
                        ...
                        disabled={withdrawSubmitting || (isWalletConnected && !withdrawAmount)}
                      >
                        {withdrawSubmitting
                          ? 'Withdrawing…'
                          : !isWalletConnected
